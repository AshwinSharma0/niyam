...
function createHabitElement(habit) {
    ...
    habitIcon.textContent = iconMap[categoryClass] || '⭐';
    ...
    const habitTime = document.createElement('p');
    habitTime.className = 'habit-time';
    habitTime.textContent = habit.duration ? `${habit.duration} min` : 'Daily';
    
    habitDetails.appendChild(habitName);
    habitDetails.appendChild(habitTime);
    
    habitLeft.appendChild(habitIcon);
    ...
    habitElement.appendChild(habitLeft);
